...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="bg-white py-24 px-6 md:px-12 lg:px-20">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="relative mt-20">
          ...
          <div className="absolute left-1/2 top-12 hidden h-0.5 w-[calc(100%-12rem)] -translate-x-1/2 md:block">
            <div className="h-full w-full origin-left bg-gradient-to-r from-sage-300 via-sage-400 to-sage-300" />
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex h-24 w-24 items-center justify-center rounded-full bg-cream-100 ring-4 ring-white shadow-card">
                    <Icon size={32} strokeWidth={1.5} className="text-terracotta-500" />
                  </div>
